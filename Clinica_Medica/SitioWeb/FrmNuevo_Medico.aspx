<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FrmNuevo_Medico.aspx.cs" Inherits="SitioWeb.FrmNuevo_Medico" %>
...
<body>
    <form id="form1" runat="server">
       <div class="container center-container" >
            <div>
                <h1 class="bg-info p-3 text-center"">Mantenimiento de Médicos</h1>
                <hr />
                <br />
                <br />
            </div>
            ...
            <div class="row">
                ...
                <div class="col-8">
                    <asp:TextBox ID="txtEspecialidad" runat="server" Width="400px"></asp:TextBox>
                </div>
            </div>
            <!--fin row-->
